  ...
  [
    {
      ...
      children: [
        ...
        { path: "/pos-transactions/pos-unsetteled", element: <PosTransUnsettled /> },
        { path: "/pos-transactions/inventory-pos", element: <PosTransInventory /> },
        { path: "/pos-transactions/pos-history", element: <PosTransHistory /> },
        { path: "/pos-transactions/pos-batches", element: <PosTransBatches /> },
        { path: "/pos-transactions/pos-customer", element: <PosTransCustomerOrder /> },
        // pos Items
        ...
        { path: "/pos-customers/delivery-address", element: <PosCusDeliveryAddress /> },
        { path: "/pos-customers/payment-methods", element: <PosCusPaymentMethods /> },
        { path: "/pos-customers/shipping-methods", element: <PosCusShippingMethods /> },
        ...
        // GS Price & Discount
        { path: "/global/price&discount/standard-selling-prices", element: <GS_StandardSellingPrices /> },
        { path: "/global/price&discount/sandard-bying-prices", element: <GS_Standardbuyingprice /> },
        { path: "/global/price&discount/standard-buying-discounts", element: <GS_StandardBuyingDiscounts /> },
        { path: "/global/price&discount/standard-selling-rate-tables", element: <GS_StandardSellingRateTables /> },
        { path: "/global/price&discount/standard-buying-rate-tables", element: <GS_StandardBuyingRateTables /> },
        { path: "/global/price&discount/special-promo-code-selling-prices", element: <GS_SpecialSellingPrices /> },
        { path: "/global/price&discount/special-promo-code-buying-prices", element: <GS_SpecialBuyingPrices /> },
        { path: "/global/price&discount/contract-selling-prices", element: <GS_ContractSellingPrices /> },
        { path: "/global/price&discount/contract-selling-discounts", element: <GS_ContractSellingDiscounts /> },
        { path: "/global/price&discount/contract-buying-prices", element: <GS_ContractBuyingPrices /> },
        { path: "/global/price&discount/contract-buying-discounts", element: <GS_ContractBuyingDiscounts /> },
        { path: "/global/price&discount/contract-list", element: <GS_CustomerList /> },
